void main(){
 var list1 = List.empty(growable: true); //List.empty() is basically a fixed length list since value of growable : false
  ...
  var list3 = List.from(list1); // List.from() we are creating a list from another list or set etc and it is basically a growable
                                 // list since value of growable : true
